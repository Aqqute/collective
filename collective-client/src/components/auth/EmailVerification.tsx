  ...
  return (
    <div className="flex flex-col items-center max-w-md mx-auto p-6 bg-white rounded-lg shadow-sm">
      ...
      <div className="mb-6 relative">
        <div className="w-24 h-24 bg-white rounded-md p-2 shadow-sm">
          <div className="w-full h-full border-2 border-gray-200 rounded-md relative flex items-center justify-center">
            <div className="absolute w-16 h-1 bg-red-500 bottom-3 left-3"></div>
            <div className="absolute top-0 w-full h-full flex items-center justify-center">
              <div className="bg-white p-1 rounded-full border border-gray-100 shadow-md">
